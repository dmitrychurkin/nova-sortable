<template>
  <div :key="forceRerenderKey" class="overflow-hidden overflow-x-auto relative">
    <table
...
export default {
  ...
  methods: {
    ...
    /**
     * Force a re-render of the ResourceTable component.
     * Fixes: https://github.com/outl1ne/nova-sortable/issues/193
     */
    forceRerender() {
